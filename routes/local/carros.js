...
const controller = require('C:/Users/LEONARDO/Documents/GitHub/AW-15799/controllers/local/carros');
...
carrosRouter.delete('/delete/:id', controller.delete); //apagar um carro pelo id
